        ...
        <nav className="mx-auto flex h-20 items-center justify-between px-4 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-6 mr-4 font-black uppercase text-[10px] tracking-widest italic opacity-70">
              ...
              {user && <Link to="/app" className="hover:text-primary transition-colors border-b-2 border-transparent hover:border-primary py-1">Dashboard</Link>}
            </div>
            ...
            {user ? (
              <div className="flex items-center gap-2">
                ...
                <div className="dropdown dropdown-end">
                  ...
                  <ul tabIndex={0} className="dropdown-content z-[100] menu p-4 shadow-2xl bg-base-100 rounded-3xl w-72 mt-4 border border-base-300 gap-2 block animate-in fade-in zoom-in duration-200">
